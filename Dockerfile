...
RUN apt-get update && apt-get install -y  gdal-bin libcurl4-openssl-dev libgdal-dev libgeos-dev libgeos++-dev libicu-dev libjq-dev libpq-dev libproj-dev libssl-dev libudunits2-dev make pandoc zlib1g-dev && rm -rf /var/lib/apt/lists/*
